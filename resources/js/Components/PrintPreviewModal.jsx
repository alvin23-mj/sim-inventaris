...
const PrintPreviewModal = ({ show, onClose, transaction, type }) => {
    ...
    return (
        <Modal show={show} onClose={onClose} maxWidth="5xl">
            <div className="p-8 font-telex">
                <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                    <div>
                        <h3 className="text-xl font-bold text-gray-800">Preview Cetak</h3>
                        <p className="text-sm text-gray-500 mt-1">Review format bukti transaksi sebelum mengunduh PDF</p>
                    </div>
                ...
                <div className="bg-gray-100 p-8 rounded-2xl border border-gray-200 mb-8 overflow-x-auto">
                    <div id="print-area" className="w-[750px] bg-white p-[30px] mx-auto text-black shadow-lg" style={{ fontFamily: 'Telex, sans-serif' }}>
                        {/* Header Template */}
                        <div className="text-center mb-8 border-b-2 border-black pb-2">
                            ...
                            <div className="text-right mt-2">
                                <span className="text-[10px] text-gray-400 font-mono italic">FORM/SEK ISO/27.REV.00</span>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between mb-8 text-[12px]">
                            ...
                            <div className="text-right space-y-1">
                                <p className="font-bold">ID: #{transaction.id.toString().padStart(5, '0')}</p>
                                <p className="text-gray-500">Petugas: {transaction.user?.name}</p>
                            </div>
                        </div>
                        ...
                        <table className="w-full border-collapse border border-black text-[12px] mb-4">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border border-black p-2 w-24 text-center font-bold align-middle">Tanggal</th>
                            ...
                            <tbody>
                                {transaction.details.map((detail, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="border border-black p-2 text-center align-middle">{transaction.transaction_date}</td>
                                ...
                                <tr className="font-bold">
                                    <td colSpan="3" className="border border-black p-2 text-right align-middle">Total</td>
                ...
                <div className="flex justify-end gap-3 border-t border-gray-100 pt-6">
                    ...
                    <CustomButton variant="primary" onClick={handleDownloadPDF} className="!px-10">
                        <i className="fas fa-file-pdf mr-2"></i> Cetak PDF (Bukti Transaksi)
                    </CustomButton>
                </div>
            </div>
        </Modal>
